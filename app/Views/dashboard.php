...
<head>
    ...
    <link href="<?php echo base_url('public/assets/css/light-bootstrap-dashboard.css'); ?>" rel="stylesheet" />
...
<script src="<?php echo base_url('public/assets/js/light-bootstrap-dashboard.js'); ?> " type="text/javascript"></script>
